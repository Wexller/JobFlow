...
| IDEA-004 | Simplify home page and add entity pages | Home page is overloaded and mixes summary with detailed workflows | Improves clarity, focus, and navigation by moving details to dedicated entity pages | High | in_review | `IDEA-004` | - | - | 2026-05-19 |
...
| IDEA-009 | Text audit and copy cleanup | Product copy still contains outdated terms (e.g., Google Sheets, mock wording) | Aligns UX language with actual runtime and improves trust | High | in_progress | `IDEA-009` | - | - | 2026-05-19 |
