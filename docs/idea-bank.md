...
| IDEA-008 | Mobile-first UI baseline | Current UI is not explicitly optimized from mobile-first constraints | Improves usability and conversion on phones and small screens | High | new | - | - | - | 2026-05-19 |
